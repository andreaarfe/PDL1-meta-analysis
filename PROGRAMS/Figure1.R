...
# Side by side plots
final <- grid.arrange(dist,
                      eff + labs(title="(b) Class-specific treatment effects"),
                      ncol=2)
...
# ggsave("./RESULTS/Figure_1_sensitivity_analysis.pdf",
#        width = 9,
#        height = 4.5,
#        plot=eff + labs(title="Class-specific treatment effects"))
